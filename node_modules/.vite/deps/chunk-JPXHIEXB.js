...
function l() {
  a = true;
  for (var t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", e2 = 0; e2 < 64; ++e2)
    o2[e2] = t[e2], i[t.charCodeAt(e2)] = e2;
  i["-".charCodeAt(0)] = 62, i["_".charCodeAt(0)] = 63;
}
function u(t, e2, n2) {
  for (var r3, i2, s2 = [], a2 = e2; a2 < n2; a2 += 3)
    r3 = (t[a2] << 16) + (t[a2 + 1] << 8) + t[a2 + 2], s2.push(o2[(i2 = r3) >> 18 & 63] + o2[i2 >> 12 & 63] + o2[i2 >> 6 & 63] + o2[63 & i2]);
  return s2.join("");
}
function c(t) {
  var e2;
  a || l();
  for (var n2 = t.length, r3 = n2 % 3, i2 = "", s2 = [], c2 = 16383, h2 = 0, f2 = n2 - r3; h2 < f2; h2 += c2)
    s2.push(u(t, h2, h2 + c2 > f2 ? f2 : h2 + c2));
  ...
  return "undefined" != typeof ArrayBuffer && e2 instanceof ArrayBuffer ? function(t2, e3, n3, r4) {
    ...
    if (e3) {
      if ("undefined" != typeof ArrayBuffer && e3.buffer instanceof ArrayBuffer || "length" in e3)
        return "number" != typeof e3.length || (r4 = e3.length) != r4 ? w(t2, 0) : A(t2, e3);
      if ("Buffer" === e3.type && p(e3.data))
        return A(t2, e3.data);
    }
    var r4;
...
function b(t, e2) {
  if (m(e2), t = w(t, e2 < 0 ? 0 : 0 | E(e2)), !y.TYPED_ARRAY_SUPPORT)
...
function N(t, e2, n2, r3, o3) {
  ...
  if ("string" == typeof e2 && (e2 = y.from(e2, r3)), T(e2))
    return 0 === e2.length ? -1 : C(t, e2, n2, r3, o3);
  if ("number" == typeof e2)
    return e2 &= 255, y.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? o3 ? Uint8Array.prototype.indexOf.call(t, e2, n2) : Uint8Array.prototype.lastIndexOf.call(t, e2, n2) : C(t, [e2], n2, r3, o3);
...
function C(t, e2, n2, r3, o3) {
  ...
  if (o3) {
    var c2 = -1;
    for (i2 = n2; i2 < a2; i2++)
      if (u2(t, i2) === u2(e2, -1 === c2 ? 0 : i2 - c2)) {
        if (-1 === c2 && (c2 = i2), i2 - c2 + 1 === l2)
          return c2 * s2;
      } else
        -1 !== c2 && (i2 -= i2 - c2), c2 = -1;
  } else
    for (n2 + l2 > a2 && (n2 = a2 - l2), i2 = n2; i2 >= 0; i2--) {
      for (var h2 = true, f2 = 0; f2 < l2; f2++)
        if (u2(t, i2 + f2) !== u2(e2, f2)) {
          h2 = false;
          break;
        }
      if (h2)
...
function U(t, e2, n2, r3) {
  return Q(function(t2, e3) {
    for (var n3, r4, o3, i2 = [], s2 = 0; s2 < t2.length && !((e3 -= 2) < 0); ++s2)
      r4 = (n3 = t2.charCodeAt(s2)) >> 8, o3 = n3 % 256, i2.push(o3), i2.push(r4);
    return i2;
...
function W(t, e2, n2) {
  ...
  return function(t2) {
    ...
    var n3 = "", r4 = 0;
    for (; r4 < e3; )
      n3 += String.fromCharCode.apply(String, t2.slice(r4, r4 += D));
    return n3;
  }(r3);
}
y.TYPED_ARRAY_SUPPORT = void 0 === r2.TYPED_ARRAY_SUPPORT || r2.TYPED_ARRAY_SUPPORT, g(), y.poolSize = 8192, y._augment = function(t) {
  ...
  if (t === e2)
    return 0;
  for (var n2 = t.length, r3 = e2.length, o3 = 0, i2 = Math.min(n2, r3); o3 < i2; ++o3)
    if (t[o3] !== e2[o3]) {
      n2 = t[o3], r3 = e2[o3];
      break;
    }
  ...
  for (var e2 = 0; e2 < t; e2 += 4)
    S(this, e2, e2 + 3), S(this, e2 + 1, e2 + 2);
  return this;
}, y.prototype.swap64 = function() {
  var t = this.length;
  if (t % 8 != 0)
    throw new RangeError("Buffer size must be a multiple of 64-bits");
  for (var e2 = 0; e2 < t; e2 += 8)
    S(this, e2, e2 + 7), S(this, e2 + 1, e2 + 6), S(this, e2 + 2, e2 + 5), S(this, e2 + 3, e2 + 4);
  return this;
  ...
  if (!T(t))
    throw new TypeError("Argument must be a Buffer");
  if (void 0 === e2 && (e2 = 0), void 0 === n2 && (n2 = t ? t.length : 0), void 0 === r3 && (r3 = 0), void 0 === o3 && (o3 = this.length), e2 < 0 || n2 > t.length || r3 < 0 || o3 > this.length)
  ...
  if (this === t)
    return 0;
  for (var i2 = (o3 >>>= 0) - (r3 >>>= 0), s2 = (n2 >>>= 0) - (e2 >>>= 0), a2 = Math.min(i2, s2), l2 = this.slice(r3, o3), u2 = t.slice(e2, n2), c2 = 0; c2 < a2; ++c2)
    if (l2[c2] !== u2[c2]) {
      i2 = l2[c2], s2 = u2[c2];
      break;
    }
  ...
  if (void 0 === e2)
    r3 = "utf8", n2 = this.length, e2 = 0;
  else if (void 0 === n2 && "string" == typeof e2)
    r3 = e2, n2 = this.length, e2 = 0;
  else {
    if (!isFinite(e2))
  ...
  if ((void 0 === n2 || n2 > o3) && (n2 = o3), t.length > 0 && (n2 < 0 || e2 < 0) || e2 > this.length)
...
function x(t, e2, n2) {
  var r3 = "";
  n2 = Math.min(t.length, n2);
  for (var o3 = e2; o3 < n2; ++o3)
    r3 += String.fromCharCode(127 & t[o3]);
  return r3;
}
function Y(t, e2, n2) {
  var r3 = "";
  n2 = Math.min(t.length, n2);
  for (var o3 = e2; o3 < n2; ++o3)
    r3 += String.fromCharCode(t[o3]);
  return r3;
}
function k(t, e2, n2) {
  var r3 = t.length;
  (!e2 || e2 < 0) && (e2 = 0), (!n2 || n2 < 0 || n2 > r3) && (n2 = r3);
  for (var o3 = "", i2 = e2; i2 < n2; ++i2)
    o3 += J(t[i2]);
  return o3;
}
function j(t, e2, n2) {
  for (var r3 = t.slice(e2, n2), o3 = "", i2 = 0; i2 < r3.length; i2 += 2)
    o3 += String.fromCharCode(r3[i2] + 256 * r3[i2 + 1]);
  return o3;
}
function $(t, e2, n2) {
  if (t % 1 != 0 || t < 0)
...
function q(t, e2, n2, r3) {
  e2 < 0 && (e2 = 65535 + e2 + 1);
  for (var o3 = 0, i2 = Math.min(t.length - n2, 2); o3 < i2; ++o3)
    t[n2 + o3] = (e2 & 255 << 8 * (r3 ? o3 : 1 - o3)) >>> 8 * (r3 ? o3 : 1 - o3);
}
function z(t, e2, n2, r3) {
  e2 < 0 && (e2 = 4294967295 + e2 + 1);
  for (var o3 = 0, i2 = Math.min(t.length - n2, 4); o3 < i2; ++o3)
    t[n2 + o3] = e2 >>> 8 * (r3 ? o3 : 3 - o3) & 255;
}
function F(t, e2, n2, r3, o3, i2) {
  if (n2 + r3 > t.length)
    throw new RangeError("Index out of range");
...
y.prototype.slice = function(t, e2) {
  ...
  if ((t = ~~t) < 0 ? (t += r3) < 0 && (t = 0) : t > r3 && (t = r3), (e2 = void 0 === e2 ? r3 : ~~e2) < 0 ? (e2 += r3) < 0 && (e2 = 0) : e2 > r3 && (e2 = r3), e2 < t && (e2 = t), y.TYPED_ARRAY_SUPPORT)
    (n2 = this.subarray(t, e2)).__proto__ = y.prototype;
  else {
    var o3 = e2 - t;
    n2 = new y(o3, void 0);
  ...
  for (var r3 = this[t], o3 = 1, i2 = 0; ++i2 < e2 && (o3 *= 256); )
    r3 += this[t + i2] * o3;
  return r3;
}, y.prototype.readUIntBE = function(t, e2, n2) {
  t |= 0, e2 |= 0, n2 || $(t, e2, this.length);
  for (var r3 = this[t + --e2], o3 = 1; e2 > 0 && (o3 *= 256); )
    r3 += this[t + --e2] * o3;
  return r3;
  ...
  t |= 0, e2 |= 0, n2 || $(t, e2, this.length);
  for (var r3 = e2, o3 = 1, i2 = this[t + --r3]; r3 > 0 && (o3 *= 256); )
    i2 += this[t + --r3] * o3;
  ...
  var o3 = 1, i2 = 0;
  for (this[e2] = 255 & t; ++i2 < n2 && (o3 *= 256); )
    this[e2 + i2] = t / o3 & 255;
  return e2 + n2;
}, y.prototype.writeUIntBE = function(t, e2, n2, r3) {
  (t = +t, e2 |= 0, n2 |= 0, r3) || G(this, t, e2, n2, Math.pow(2, 8 * n2) - 1, 0);
  var o3 = n2 - 1, i2 = 1;
  for (this[e2 + o3] = 255 & t; --o3 >= 0 && (i2 *= 256); )
    this[e2 + o3] = t / i2 & 255;
  return e2 + n2;
  ...
  var i2 = 0, s2 = 1, a2 = 0;
  for (this[e2] = 255 & t; ++i2 < n2 && (s2 *= 256); )
    t < 0 && 0 === a2 && 0 !== this[e2 + i2 - 1] && (a2 = 1), this[e2 + i2] = (t / s2 | 0) - a2 & 255;
  return e2 + n2;
  ...
  for (this[e2 + i2] = 255 & t; --i2 >= 0 && (s2 *= 256); )
    t < 0 && 0 === a2 && 0 !== this[e2 + i2 + 1] && (a2 = 1), this[e2 + i2] = (t / s2 | 0) - a2 & 255;
  return e2 + n2;
  ...
  if (n2 || (n2 = 0), r3 || 0 === r3 || (r3 = this.length), e2 >= t.length && (e2 = t.length), e2 || (e2 = 0), r3 > 0 && r3 < n2 && (r3 = n2), r3 === n2)
    return 0;
  ...
  if (this === t && n2 < e2 && e2 < r3)
    ...
    Uint8Array.prototype.set.call(t, this.subarray(n2, n2 + i2), e2);
  return i2;
  ...
  if ("string" == typeof t) {
    ...
    if ("string" == typeof r3 && !y.isEncoding(r3))
      throw new TypeError("Unknown encoding: " + r3);
  } else
  ...
  if (n2 <= e2)
    return this;
  var i2;
  if (e2 >>>= 0, n2 = void 0 === n2 ? this.length : n2 >>> 0, t || (t = 0), "number" == typeof t)
    for (i2 = e2; i2 < n2; ++i2)
      this[i2] = t;
  else {
    var s2 = T(t) ? t : V(new y(t, r3).toString()), a2 = s2.length;
    for (i2 = 0; i2 < n2 - e2; ++i2)
      this[i2 + e2] = s2[i2 % a2];
  }
  return this;
};
...
function Z(t) {
  return function(t2) {
    ...
    var f2 = 0;
    for (e2 = 0, n2 = 0; e2 < r3; e2 += 4, n2 += 3)
      o3 = i[t2.charCodeAt(e2)] << 18 | i[t2.charCodeAt(e2 + 1)] << 12 | i[t2.charCodeAt(e2 + 2)] << 6 | i[t2.charCodeAt(e2 + 3)], c2[f2++] = o3 >> 16 & 255, c2[f2++] = o3 >> 8 & 255, c2[f2++] = 255 & o3;
...
function Q(t, e2, n2, r3) {
  for (var o3 = 0; o3 < r3 && !(o3 + n2 >= e2.length || o3 >= t.length); ++o3)
    e2[o3 + n2] = t[o3];
  return o3;
}
function tt(t) {
  ...
  return new Promise((e2, n2) => {
    try {
      ...
      const i2 = setInterval(() => {
        if (o3 += 1, o3 === it)
          return clearInterval(i2), void n2(new nt({ type: "MESSAGE_NOT_RECEIVED" }, "Couldn't open Pera Wallet, please try again."));
      ...
      try {
        ...
        rt.setupListener({ onReceiveMessage: (e3) => function({ event: t3, newPeraWalletTab: e4, resolve: n3, reject: r4 }) {
          if (n3 && "CONNECT_CALLBACK" === t3.data.message.type) {
            ...
            "CONNECT_NETWORK_MISMATCH" === t3.data.message.type && (r4(new nt({ type: "CONNECT_NETWORK_MISMATCH", detail: t3.data.message.error }, t3.data.message.error || "Your wallet is connected to a different network to this dApp. Update your wallet to the correct network (MainNet or TestNet) to continue.")), vt(ut), null == e4 || e4.close());
...
var jt = class {
  ...
  connect(e2) {
    return new Promise((n2, r3) => et(this, void 0, void 0, function* () {
      var o3;
      try {
        if (null === (o3 = this.connector) || void 0 === o3 ? void 0 : o3.connected)
          try {
  ...
  signTransaction(t, n2) {
    return et(this, void 0, void 0, function* () {
      if ("mobile" === this.platform && (Mt() ? gt() : !Mt() && this.shouldShowSignTxnToast && wt(), !this.connector))
...
"undefined" != typeof window && (window.global = window, window.Buffer = window.Buffer || y, import("./App-428f5096-BYB5OYXM.js"));
...
bowser/src/bowser.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JPXHIEXB.js.map
